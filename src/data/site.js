...
export const portfolioItems = [
  ...
  // --- Vídeo / brand campaign ---
  {
    ...
    alt: 'Videoclip musical para Decathlon, marca Kuikma Padel',
    video: true,
  ...
  },
  {
    sector: 'video',
    subsection: 'campaign',
    title: 'Videoclip — Sofía Ellar',
    image: '/fotos/marca-redes/marca-12.jpg',
    alt: 'Videoclip musical de la artista Sofía Ellar',
    video: true,
  ...
  },
  {
    sector: 'video',
    subsection: 'campaign',
    title: 'Making of de campaña de vídeo para Elisabeth Arden',
