...
export const portfolioSectors = [
  ...
  },
  {
    slug: 'fotografia',
    label: 'Fotografía',
    intro: 'Fotografía por especialidades: eventos, retrato corporativo, clínica dental, interiorismo, y campañas editoriales y de marca.',
    subsections: [
      { key: 'retrato', label: 'Retrato corporativo' },
      { key: 'eventos', label: 'Eventos' },
      { key: 'clinicadental', label: 'Clínica dental' },
...
export const portfolioItems = [
  ...
  // --- Fotografía / eventos ---
  {
    ...
    image: '/fotos/eventos/evento-06.jpg',
    alt: 'Asistente sonriendo entre el público durante un evento corporativo',
  },
  {
    sector: 'fotografia',
    subsection: 'eventos',
    title: 'Evento corporativo — ponencia',
    image: '/fotos/eventos/evento-07.jpg',
    alt: 'Ponente hablando con micrófono durante un evento corporativo',
  },
  {
    sector: 'fotografia',
    subsection: 'eventos',
    title: 'Evento corporativo — networking en terraza',
    image: '/fotos/eventos/evento-08.jpg',
    alt: 'Grupo de asistentes conversando y riendo en la terraza de un evento',
  },
  {
    sector: 'fotografia',
    subsection: 'eventos',
    title: 'Evento corporativo — brindis',
    image: '/fotos/eventos/evento-09.jpg',
    alt: 'Asistentes brindando con copas de vino durante un evento corporativo',
  },
  {
    sector: 'fotografia',
    subsection: 'eventos',
    title: 'Evento corporativo — turno de preguntas',
    image: '/fotos/eventos/evento-10.jpg',
    alt: 'Asistente haciendo una pregunta con micrófono durante un evento',
  },
  {
    sector: 'fotografia',
    subsection: 'eventos',
    title: 'Evento corporativo — equipo creativo',
    image: '/fotos/eventos/evento-11.jpg',
    alt: 'Miembro de un equipo creativo trabajando durante una jornada de evento',
  },
  {
    sector: 'fotografia',
    subsection: 'eventos',
    title: 'Evento corporativo — público',
    image: '/fotos/eventos/evento-12.jpg',
    alt: 'Asistente atento entre el público durante un evento corporativo',
  },
  {
    sector: 'fotografia',
    subsection: 'eventos',
    title: 'Evento corporativo — momento distendido',
    image: '/fotos/eventos/evento-13.jpg',
    alt: 'Momento distendido y divertido durante un evento corporativo',
  },
  // --- Fotografía / clínica dental ---
  {
    sector: 'fotografia',
    subsection: 'clinicadental',
    title: 'Clínica dental — tratamiento con luz LED',
    image: '/fotos/clinica-dental/dental-01.jpg',
    alt: 'Paciente recibiendo un tratamiento dental con lámpara de luz LED',
  },
  {
    sector: 'fotografia',
    subsection: 'clinicadental',
    title: 'Clínica dental — blanqueamiento',
    image: '/fotos/clinica-dental/dental-02.jpg',
    alt: 'Dentista realizando un tratamiento de blanqueamiento dental',
  },
  {
    sector: 'fotografia',
    subsection: 'clinicadental',
    title: 'Clínica dental — resultado final',
    image: '/fotos/clinica-dental/dental-03.jpg',
    alt: 'Paciente sonriendo al espejo tras un tratamiento dental',
  },
  // --- Fotografía / interiorismo ---
  {
    sector: 'fotografia',
    subsection: 'interiorismo',
    title: 'Interiorismo — showroom',
    image: '/fotos/interiorismo/interiorismo-01.jpg',
    alt: 'Salón de un showroom de interiorismo con sofás y escultura decorativa',
  },
  {
    sector: 'fotografia',
    subsection: 'interiorismo',
    title: 'Interiorismo — rincón de comedor',
    image: '/fotos/interiorismo/interiorismo-02.jpg',
    alt: 'Rincón de comedor con mesa de mármol y cuadro de una escalera',
  },
  {
    sector: 'fotografia',
    subsection: 'interiorismo',
    title: 'Interiorismo — salón con arte',
    image: '/fotos/interiorismo/interiorismo-03.jpg',
    alt: 'Salón con obra de arte abstracta y sillón de mimbre',
  },
  {
    sector: 'fotografia',
    subsection: 'interiorismo',
    title: 'Interiorismo — pared de galería',
    image: '/fotos/interiorismo/interiorismo-04.jpg',
    alt: 'Salón con pared de mármol y tres láminas enmarcadas sobre el sofá',
  },
  ...
  // --- Vídeo / real estate ---
  {
    ...
    title: 'Vídeo inmobiliario — interiorismo. Rol: grabación. Proyecto de la mano de Luengui Productions',
    image: '/fotos/marca-redes/marca-36.jpg',
    alt: 'Rodaje de vídeo inmobiliario, entrada con paneles de madera y escalera, grabación propia, proyecto de la mano de Luengui Productions',
    video: true,
  ...
  },
  {
    sector: 'video',
    subsection: 'realestate',
    title: 'Vídeo inmobiliario — dormitorio principal. Rol: grabación. Proyecto de la mano de Luengui Productions',
    image: '/fotos/marca-redes/marca-37.jpg',
    alt: 'Rodaje de vídeo inmobiliario de una vivienda de lujo, grabación propia, proyecto de la mano de Luengui Productions',
    video: true,
  ...
  },
  {
    sector: 'video',
    subsection: 'realestate',
    title: 'Vídeo inmobiliario — presentación a medida. Rol: grabación. Proyecto de la mano de Luengui Productions',
    image: '/fotos/marca-redes/marca-38.jpg',
    alt: 'Presentadora en un rodaje de vídeo inmobiliario, grabación propia, proyecto de la mano de Luengui Productions',
    video: true,
  ...
  // --- Vídeo / social media ---
  {
    sector: 'video',
    subsection: 'social',
    title: 'Social media — Croft Twist, brindis en piscina. Rol: grabación + edición. Proyecto enmarcado en colaboración con CharHadas',
    image: '/fotos/marca-redes/marca-47.jpg',
    alt: 'Dos personas brindando con cócteles Croft Twist junto a una piscina, rol grabación y edición, proyecto en colaboración con CharHadas',
    video: true,
  ...
  },
  {
    sector: 'video',
    subsection: 'social',
    title: 'Social media — Croft Twist, evento en terraza. Rol: grabación + edición. Proyecto enmarcado en colaboración con CharHadas',
    image: '/fotos/marca-redes/marca-48.jpg',
    alt: 'Invitado con una copa de Croft Twist en un evento de marca al aire libre, rol grabación y edición, proyecto en colaboración con CharHadas',
    video: true,
  ...
  },
  {
    sector: 'video',
    subsection: 'social',
    title: 'Social media — Croft Twist, servicio. Rol: grabación + edición. Proyecto enmarcado en colaboración con CharHadas',
    image: '/fotos/marca-redes/marca-49.jpg',
    alt: 'Sirviendo un cóctel Croft Twist en una copa, rol grabación y edición, proyecto en colaboración con CharHadas',
    video: true,
  ...
  },
  {
    sector: 'eventos-corporativos',
    subsection: 'conferencias',
    title: 'Conferencia corporativa — sala llena',
    image: '/fotos/eventos/evento-14.jpg',
    alt: 'Público asistiendo a una conferencia corporativa en una sala amplia',
  },
  {
    sector: 'eventos-corporativos',
    subsection: 'conferencias',
    title: 'Conferencia corporativa — ponente en escenario',
    image: '/fotos/eventos/evento-15.jpg',
    alt: 'Ponente aplaudiendo sobre el escenario durante una conferencia corporativa',
  },
  ...
  },
  {
    sector: 'eventos-corporativos',
    subsection: 'networking',
    title: 'Networking de marca — conversación en terraza',
    image: '/fotos/eventos/evento-16.jpg',
    alt: 'Dos asistentes conversando bajo una sombrilla en la terraza de un evento',
  },
